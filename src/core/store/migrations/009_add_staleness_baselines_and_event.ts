...
/**
 * ADR-015 Task 015-07: semantic staleness baselines + `staleness_detected` observation type.
 */
export function upAddStalenessBaselinesAndEvent(db: AegisDatabase): void {
  db.exec(`
    CREATE TABLE IF NOT EXISTS staleness_baselines (
  ...
  if (sqlRows.sql.includes('staleness_detected')) return;
    ...
    CREATE TABLE observations_new (
        ...
        event_type          TEXT NOT NULL
                            CHECK (event_type IN ('compile_miss', 'review_correction',
                                                  ...
                                                  'doc_gap_detected', 'staleness_detected')),
...
export const migration009: Migration = {
  version: 9,
  name: 'add_staleness_baselines_and_event',
  up: upAddStalenessBaselinesAndEvent,
};
